...
const Hero: React.FC = () => (
  <section className="pt-16 pb-20 bg-gradient-to-tr from-yellow-200 via-green-200 to-blue-300 transition-colors duration-1000">
    <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        <img src="https://placehold.co/600x400/34d399/ffffff?text=EV+Illustration" alt="Electric Vehicle Illustration" className="rounded-lg shadow-2xl w-full h-auto transform transition-transform duration-700 hover:scale-105 hover:shadow-3xl" />
      </div>
    </div>
  </section>
);
